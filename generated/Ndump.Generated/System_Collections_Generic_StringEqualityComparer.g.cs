...
public sealed class StringEqualityComparer : global::_.System.Object
{
    ...
    public static StringEqualityComparer FromAddress(ulong address, DumpContext ctx)
        => new StringEqualityComparer(address, ctx);

    public static global::System.Collections.Generic.IEnumerable<StringEqualityComparer> GetInstances(DumpContext ctx)
    {

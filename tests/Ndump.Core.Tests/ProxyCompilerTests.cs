...
public class ProxyCompilerTests
{
    ...
    public void Compile_GeneratedProxyType_HasExpectedMembers()
    {
        ...
        var proxyType = result.Assembly!.GetType("Ndump.Generated.Sample");
    ...
    public void Compile_MultipleTypes_WithCrossReferences_Succeeds()
    {
        ...
        var genOrder = result.Assembly!.GetType("Ndump.Generated.Order");
        var genCustomer = result.Assembly.GetType("Ndump.Generated.Customer");
    ...
    public void Compile_ToDisk_ProducesFile()
    {
        ...
        // Note: can't delete tempDir because Assembly.LoadFrom locks the file.
